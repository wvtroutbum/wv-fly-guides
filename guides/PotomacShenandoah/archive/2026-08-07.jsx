...
const SCHEDULE = [
  { time: "5:00–7:00", window: "Dawn", tactic: "Poppers & deer-hair bugs", note: "Work shallow banks and log jams before light; topwater action peaks in first 45 min. South Branch running 136 CFS — good push of water for early morning wade", hot: true },
  ...
  return (
    <div className="fg-root">
      ...
      <div className="fg-conditions">
        ...
        <div className="fg-cond-item"><div className="fg-cond-dot" /><span>South Branch at Moorefield: 136 CFS · Temp N/A</span></div>
        ...
        <span className="fg-cond-updated">Last updated: Friday, July 31 2026</span>
      </div>
